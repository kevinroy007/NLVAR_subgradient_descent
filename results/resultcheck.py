...
cost_n = pickle.load(open("cost_n_s.txt","rb"))
cost_n_test = pickle.load(open("cost_n_test_s.txt","rb"))
cost_linear = pickle.load(open("cost_linear_s.txt","rb"))
cost_linear_test = pickle.load(open("cost_linear_test_s.txt","rb"))
A_n = pickle.load(open("A_n_s.txt","rb"))
A_l = pickle.load(open("A_l_s.txt","rb"))
...
thresholds = np.arange(-1,0.4,0.05)
